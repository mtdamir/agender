...
from tensorflow.keras.layers import (Input, Activation, Dense, Flatten, Dropout, Multiply, Embedding, Lambda, 
                                     Add, Concatenate, Conv2D, AveragePooling2D, MaxPooling2D, BatchNormalization)
